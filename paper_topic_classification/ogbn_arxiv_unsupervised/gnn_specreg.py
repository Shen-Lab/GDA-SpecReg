...
def train(model, data, train_idx, val_idx, optimizer, critic, optimizer_c, gamma, eival, eivec, gamma_ss, thres_ss, gamma_mfr, thres_mfr):
    model.train()
...
def main():
    ...
    for run in range(args.runs):
        ...
        for epoch in range(1, 1 + args.epochs):
            loss, loss_c = train(model, data, train_idx[idx_rand], split_idx['valid'], optimizer, critic, optimizer_c, args.gamma, eival, eivec, args.gamma_ss, args.thres_ss, args.gamma_mfr, args.thres_mfr)
