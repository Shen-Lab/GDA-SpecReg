...
# graphcl
weight_dict = torch.load('../code_graphcl/weights/human_yeast_transformer32_gin2_epoch99.pt')
seq_encoder.load_state_dict(weight_dict['seq_encoder'])
graph_encoder.load_state_dict(weight_dict['graph_encoder'])
...
def save_model(metrics):
    weight_path = './weights/graphcl_' + args.src_species + '_' + args.tgt_species
